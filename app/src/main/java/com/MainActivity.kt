...
import com.remote.AuthApiService
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val authApiService = RetrofitClient.getInstance("https://dummyjson.com/").create(AuthApiService::class.java)
        ...
        btnLogin.setOnClickListener {
            lifecycleScope.launch {
                ...
                val request = authApiService.login(requestBody)
